...
import { X, ShieldAlert, QrCode, CreditCard, Landmark, Wallet, CheckCircle2, Download, Radio } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-black border-2 border-neutral-900 rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        {confirmedBooking ? (
          <div className="p-6 overflow-y-auto space-y-6 text-center bg-black">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400 mt-1">Booking ID: <strong className="text-red-500 font-mono">{confirmedBooking.id}</strong></p>
            </div>

            <div className="bg-neutral-950 border border-neutral-800 rounded-2xl p-5 text-left space-y-4 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <span className="text-neutral-200 font-bold">{confirmedBooking.customerName}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="text-neutral-300 font-medium">{confirmedBooking.pickupPoint}</span>
                </div>
                <div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <button
                onClick={() => alert(`Downloading Digital Ticket PDF for Booking #${confirmedBooking.id}...`)}
                className="px-5 py-2.5 rounded-xl bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 text-neutral-200 font-bold text-xs flex items-center gap-2 transition"
              >
          ...
          <form onSubmit={handlePayNow} className="p-6 overflow-y-auto space-y-6 flex-1 bg-black">
            <div className="bg-neutral-950 border border-neutral-900 p-4 rounded-2xl space-y-2">
              <div className="text-xs text-neutral-400 uppercase font-bold tracking-wider">Booking Summary</div>
              <h4 className="text-base font-bold text-white">{trip.name}</h4>
              <div className="text-xs text-neutral-300 flex items-center justify-between pt-2 border-t border-neutral-900">
              ...
              <div className="text-sm font-extrabold text-white flex items-center justify-between pt-2 border-t border-neutral-900">
                <span>Grand Total:</span>
                <span className="text-red-500 text-lg font-black">₹{grandTotal.toLocaleString('en-IN')}</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-neutral-400 uppercase mb-1">Phone Number (For Live Updates)</label>
                  <input
                    type="text"
                    required
            ...
            <div className="space-y-3">
              ...
              {paymentMethod === 'UPI' && (
                <div className="bg-neutral-950 border border-neutral-800 p-4 rounded-2xl text-center space-y-2">
                  <div className="w-24 h-24 bg-white p-2 rounded-xl mx-auto flex items-center justify-center border border-neutral-700">
                    <QrCode className="w-20 h-20 text-black" />
                  </div>
                  <p className="text-xs text-neutral-400 font-mono">Scan QR via PhonePe, GPay, Paytm, or BHIM</p>
